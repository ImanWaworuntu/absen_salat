...
import { ScanLine, Users, FileText, LogOut, Menu, ShieldAlert } from "lucide-react"
import { Button } from "@/components/ui/button"
import { useState } from "react"
import Image from "next/image"
import { logout } from "./actions"

export default function ClientSidebar({ role, email }: { role: string, email: string | null }) {
  ...
  if (role === "admin") {
    ...
    navItems.push({ name: "Manajemen Guru", href: "/admin/users", icon: ShieldAlert })
  }
